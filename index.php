                ...
                <div class="whiteContainer">
                    ...
                    <div id="welcome" class="container-fluid">
                        ...
                        <div id="welcomeSection" class="container-fluid">
                            ...
                            <div class="container">
                                <div id="textBoxContainer row">
                                    <div id="welcomeTextBox1" class="welcomeTextBox col-xs-4">
                                    ...
                                    <div id="welcomeTextBox2" class="welcomeTextBox col-xs-4">
                                        <h4 class="text-left">We specialise in helping you to:</h4>
                        ...
                        <div id="etlSection" class="container">
                            <img id="etlTaglineImg" src="img/png/etlTagline.png">
                            <div class="row">
                                <div class="col-sm-12">
                            ...
                            <div class="row verticalAlignLgOnly">
                                ...
                                <div class="col-sm-12 col-md-6 textBox">
                                    ...
                                    <h4 class="text-left">Whether you are returning from injury, looking to alleviate postural problems or back pain, want to improve your fitness or sports performance, or even just trying to improve your energy levels, here at Elevate Health &amp; Fitness, we will provide you with a unique exercise program based on your needs, goals and assessments taken at the beginning of your journey. This program will ensure you can function at your best and will be tailored around your life.
                            </h4>
                                </div>
                            </div>
                            <hr />
                            ...
                            <div class="row verticalAlignLgOnly">
                                <div class="col-sm-12 col-md-6 textBox">
                                    ...
                                    <h4 class="text-left">So you eat and train smart, but the rest of your life is a hectic, stressful merry-go-round that leaves you exhausted and struggling to cope? To get the most out of your training and nutrition programs we emphasise the importance of lifestyle factors such as sleep and relaxation and the massive benefits they can have on your overall health and wellbeing. We will provide you with strategies to help you function at your best and get the most from your program! 
                            </h4>
                                </div>
                                <div class="col-md-6">
                                    <div class="bigScreenImg imgWrapper">
